...
function runCalc() {
    ...
    el_2_total_phases_75_out.innerHTML = Math.round(_2_total_phases * parseInt(el_2_total_phases_cnt.value));
    el_2_total_neutral_out.innerHTML = _2_total_neutral;
    el_2_total_neutral_75_out.innerHTML = Math.round(_2_total_neutral * parseInt(el_2_total_neutral_cnt.value));
